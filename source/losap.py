...
The total leave is found by using the indecies of the
first and last relavent indecies. These 
are found by iterating over all status changes and
checking the dates to see if it is within the specified
